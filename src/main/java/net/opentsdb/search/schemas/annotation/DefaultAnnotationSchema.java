...
/**
 * Default implementation of the {@link AnnotationSchema}.
 */
public class DefaultAnnotationSchema extends AnnotationSchema {
   ...
   * was null or empty.
   */
  public DefaultAnnotationSchema(final ElasticSearch es) {
    super(es);
  }
